...
export const ManageBrands = () => {
  const { data: brands, refetch } = useQuery('brands', () => axios.get('/brands').then(res => res.data));
  const mutation = useMutation(
        async (newCar) => await axios.post('https://backend-car-rentals.vercel.app/brand', newBrand , {
          headers: {
