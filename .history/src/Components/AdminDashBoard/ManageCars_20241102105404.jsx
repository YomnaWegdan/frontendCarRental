...
export const ManageCars = () => {
  ...
  const handleCoverImagesChange = (e) => {
    const files = event.target.files; // This should be a FileList with multiple files if multiple are selected
    console.log(files);
    setNewCar({ ...newCar, coverImages: Array.from(e.target.files) });
  };
      ...
      <div className="row justify-content-between align-items-center">
        {cars?.map((car) => (
          <div className="row border rounded my-3 p-3" key={car._id}>
            ...
            <div className="col-md-4 d-flex justify-content-end h-50  ">
            <button className="btn btn-dark" onClick={() => handleUpdate(car._id)}>
            Update
          </button>
              ...
              <form>
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    id="coverImages" name="coverImages"
                    multiple
