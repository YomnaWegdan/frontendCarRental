...
export const ManageCars = () => {
  ...
  return (
    <div className="container">
      <div className="row">
        {cars?.map((car) => (
          <div key={car._id} className="col-lg-4 col-md-6 col-sm-12 my-3">
            <div className="card">
              <img src={car.image.secure_url} alt={car.model} className="card-img-top" />
              <div className="card-body">
                <h5 className="card-title">{car.model}</h5>
                <p className="card-text">Year: {car.year}</p>
                <p className="card-text">Price Per Day: ${car.pricePerDay}</p>
                <p className="card-text">Brand: {car.brand?.name}</p>
                <button className="btn btn-dark me-2" onClick={() => handleUpdate(car._id)}>
                  Update
                </button>
                <button className="btn btn-danger" onClick={() => deleteCar(car._id)}>
                  Delete
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form>
                ...
                <div className="mb-3">
                  <label htmlFor="coverImages" className="form-label">Cover Images</label>
                  <input type="file" className="form-control" id="coverImages" onChange={handleCoverImagesChange} multiple />
                </div>
              </form>
            </div>
