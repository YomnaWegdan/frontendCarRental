        ...
        {bookings?.map((booking) => {
          ...
          return (
            <div className="col-md-4 mb-4" key={booking._id}>
              <div className="card">
                <img src={booking.car?.image.secure_url || "default-image.jpg"} className="card-img-top" alt={booking.car?.model} />
                <div className="card-body">
                  <h5 className="card-title">{booking.car?.model}</h5>
                  <p className="card-text"><strong>User:</strong> {user ? user.name : "Unknown User"}</p>
                  <p className="card-text"><strong>Start Date:</strong> {new Date(booking.startDate).toLocaleDateString()}</p>
                  <p className="card-text"><strong>End Date:</strong> {new Date(booking.endDate).toLocaleDateString()}</p>
                  ...
                  <div className="d-flex justify-content-between">
                    ...
                    <button className="btn btn-warning" onClick={() => cancelBooking(booking._id)}>
                      Cancel
                    </button>
                  </div>
                </div>
