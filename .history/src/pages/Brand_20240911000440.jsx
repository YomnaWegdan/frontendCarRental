...
const Brand = () => {
  ...
  return (
    ...
    {brands.map((brand, index) => (
      ...
      <div className="card border-0 shadow bg-light my-2" >
        <div className="card-header border-0 shadow bg-light" id={`heading${index}`}>
          <h5 className="mb-0">
            <button
        ...
        >
          <div className="card-body row">
              {brand.cars.map((car) => (
                <div key={car._id} className=' col-md-3 shadow'>
                <NavLink to={`/cars/${car._id}`} className=" text-decoration-none main-color">
                <img src={car.image.secure_url} alt={car.model} height={100} className="w-100 object-fit-cover "/>
                </NavLink>
