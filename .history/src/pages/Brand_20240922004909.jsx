...
const Brand = () => {
  ...
  return (
    <div className="container my-5 m">
        ...
        >
          <div className="card-body row">
              {brand.cars.map((car) => (
                ...
                <NavLink to={`/cars/${car._id}`} className="">
                <img src={car.image.secure_url} alt={car.model} height={100} className="w-100 object-fit-cover card-item p-1 "/>
                </NavLink>
